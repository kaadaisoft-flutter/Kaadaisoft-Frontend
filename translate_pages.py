...
# We will just append all translations to app_en.arb and app_ta.arb
en_arb_path = r'c:\Users\kalai\StudioProjects\kaadaisoft\kaadaisoft_frontend\lib\l10n\app_en.arb'
ta_arb_path = r'c:\Users\kalai\StudioProjects\kaadaisoft\kaadaisoft_frontend\lib\l10n\app_ta.arb'
...
def update_arb(arb_path, new_keys):
...
update_arb(en_arb_path, privacy_en)
update_arb(ta_arb_path, privacy_ta)
...
def replace_in_file(path, replacements):
    ...
    for old, new_key in replacements:
        if isinstance(old, str):
            content = content.replace(f"'{old}'", f"AppLocalizations.of(context)?.{new_key} ?? '{old}'")
            content = content.replace(f"\"{old}\"", f"AppLocalizations.of(context)?.{new_key} ?? '{old}'")
        else:
            content = old.sub(new_key, content)
            
    with open(path, 'w', encoding='utf-8') as f:
        f.write(content)

privacy_replacements = [
    ("Your privacy and data security are our top priorities.", "privacySubTitle"),
    ("LAST UPDATED: MAY 07, 2026", "lastUpdated"),
    ("At **Poondurai Kaadai Kulam**, we are committed to protecting your personal data and ensuring that your privacy is respected. This policy explains how we collect, use, and safeguard your information.", "privacyIntro"),
    ("1. Information We Collect", "privacySec1Title"),
    ("We collect information you provide directly to us when you register for an account, including:", "privacySec1Desc"),
    ("Personal Identity", "privacySec1Item1Title"),
    ("Full name and photographs.", "privacySec1Item1Desc"),
    ("Contact Details", "privacySec1Item2Title"),
    ("Mobile number and physical address.", "privacySec1Item2Desc"),
    ("Community Data", "privacySec1Item3Title"),
    ("Family membership details and role assignments.", "privacySec1Item3Desc"),
    ("2. How We Use Your Information", "privacySec2Title"),
    ("The information we collect is strictly used for community management purposes:", "privacySec2Desc"),
    ("Verifying community membership and user authenticity.", "privacySec2Item1"),
    ("Processing tax payments and generating official receipts.", "privacySec2Item2"),
    ("Coordinating community events and member updates.", "privacySec2Item3"),
    ("Maintaining a secure and transparent community registry.", "privacySec2Item4"),
    ("3. Data Sharing & Disclosure", "privacySec3Title"),
    ("We do not sell, trade, or rent your personal information to third parties. Your data is only visible to authorized platform administrators and coordinators for verification purposes within the Poondurai Kaadai Kulam community ecosystem.", "privacySec3Desc"),
    ("4. Security Measures", "privacySec4Title"),
    ("We implement a variety of security measures to maintain the safety of your personal information. Your data is stored on secure servers and access is restricted to authorized personnel only. While we strive for absolute security, please note that no method of digital storage is 100% impenetrable.", "privacySec4Desc"),
    ("5. Your Data Rights", "privacySec5Title"),
    ("You have the right to access and update your information at any time. If you wish to correct your data or request account closure, you can manage your profile settings or contact the administrator directly.", "privacySec5Desc"),
    ("6. Cookies & Tracking", "privacySec6Title"),
    ("Our platform may use essential session cookies to keep you logged in and ensure the website functions correctly. We do not use tracking cookies for advertising purposes.", "privacySec6Desc"),
    ("7. Changes to This Policy", "privacySec7Title"),
    ('We may update this Privacy Policy to reflect changes in our practices. Any updates will be posted on this page with an updated "Last Updated" date.', "privacySec7Desc"),
    ("8. Contact Our Team", "privacySec8Title"),
    ("If you have any questions or concerns regarding this Privacy Policy or your data, please reach out to the platform administrator.", "privacySec8Desc"),
    ("© 2026 Poondurai Kaadai Kulam. All rights reserved.", "allRightsReserved"),
    ("Back to Login", "backToLogin"),
]

terms_replacements = [
    ("Legal agreement for using Poondurai Kaadai Kulam platform", "termsSubTitle"),
    ("LAST UPDATED: MAY 07, 2026", "lastUpdated"),
    ("Please read these terms and conditions carefully before using our services. By using our platform, you agree to comply with and be bound by these terms.", "termsIntro"),
    ("1. Agreement to Terms", "termsSec1Title"),
    ("By accessing or using our website, you agree to be bound by these Terms and Conditions and our Privacy Policy. If you do not agree with any part of these terms, you must not use our services. This agreement constitutes a legally binding contract between you and Poondurai Kaadai Kulam.", "termsSec1Desc"),
    ("2. User Registration", "termsSec2Title"),
    ("To access certain features of the website, you are required to register for an account. You agree to provide accurate, current, and complete information during the registration process (Mobile Number, Address, etc.) and to update such information to keep it accurate, current, and complete.", "termsSec2Desc"),
    ("3. Responsibility for Account", "termsSec3Title"),
    ("You are solely responsible for maintaining the confidentiality of your account password and for all activities that occur under your account. You agree to notify us immediately of any unauthorized use of your account or any other breach of security.", "termsSec3Desc"),
    ("4. Use of Information", "termsSec4Title"),
    ("The information provided on this platform is for community management and membership purposes. While we strive to maintain high data accuracy, we do not warrant the completeness or reliability of user-submitted information at all times.", "termsSec4Desc"),
    ("5. Prohibited Activities", "termsSec5Title"),
    ("You agree not to use the platform for any unlawful purpose or any purpose prohibited under these Terms. Prohibited activities include but are not limited to: uploading false documents, attempting to breach security, or harassing other community members.", "termsSec5Desc"),
    ("6. Intellectual Property", "termsSec6Title"),
    ("All content included on this website, such as custom scripts, branding, UI designs, and logos, is the property of Poondurai Kaadai Kulam or its content suppliers and is protected by copyright laws.", "termsSec6Desc"),
    ("7. Termination of Use", "termsSec7Title"),
    ("We reserve the right to terminate or suspend your access to the platform without notice, for any conduct that we, in our sole discretion, believe is in violation of any applicable law or is harmful to the interests of the community.", "termsSec7Desc"),
    ("8. Changes to Terms", "termsSec8Title"),
    ("We reserve the right to modify these Terms and Conditions at any time. Changes will be effective immediately upon posting. Your continued use of the website following changes will mean that you accept and agree to the modified terms.", "termsSec8Desc"),
    ("© 2026 Poondurai Kaadai Kulam. All rights reserved.", "allRightsReserved"),
    ("Back to Login", "backToLogin"),
]

replace_in_file(r'c:\Users\kalai\StudioProjects\kaadaisoft\kaadaisoft_frontend\lib\presentation\pages\privacy_policy_page.dart', privacy_replacements)
replace_in_file(r'c:\Users\kalai\StudioProjects\kaadaisoft\kaadaisoft_frontend\lib\presentation\pages\terms_and_conditions_page.dart', terms_replacements)

# Now, we also need to fix `const Text(` -> `Text(` for all of those because AppLocalizations is not const.
def remove_const_text(path):
    with open(path, 'r', encoding='utf-8') as f:
        content = f.read()
    ...
    # Also for Text( ... style: const TextStyle(...)) if there's an outer const that should be removed
    # Like `child: const Text(` -> `child: Text(`
    content = re.sub(r'const Text\(\s*AppLocalizations', r'Text(AppLocalizations', content)
    
    with open(path, 'w', encoding='utf-8') as f:
        f.write(content)

remove_const_text(r'c:\Users\kalai\StudioProjects\kaadaisoft\kaadaisoft_frontend\lib\presentation\pages\privacy_policy_page.dart')
remove_const_text(r'c:\Users\kalai\StudioProjects\kaadaisoft\kaadaisoft_frontend\lib\presentation\pages\terms_and_conditions_page.dart')
